...
import '12.PageTwelve.dart';

class PageTen extends StatefulWidget {
  final String tenimagePath;

  const PageTen({Key? key, required this.tenimagePath}) : super(key: key);

  void navigateToNextPage(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) =>
            PageTwelve(twelveimagePath: tenimagePath), // 이미지 경로를 전달
      ),
    );
  }
